...
void move_rocket(double angle, double scale, body_t *pacman) {
  ...
  // body_set_velocity(pacman, vec_multiply(PACMAN_VELOCITY_SCALE,
  // move_vector));
}
...
int main(int argc, char *argv[]) {
  ...
  scene_add_camera_management(scene, (camera_offset_func_t)camera_offset_func,
                              (camera_mover_func_t)camera_mover_func, NULL,
                              NULL);
