...
drag_params_t *drag_params_init(
    double gamma,
    body_t *body)
{
    drag_params_t *params = malloc(sizeof(drag_params_t));
    *params = (drag_params_t){
        .gamma = gamma,
        .body = body};
    return params;
}
...
destructive_params_t *destructive_params_init(body_t *body1, body_t *body2)
{
    ...
    *params = (destructive_params_t){
        .body1 = body1,
        .body2 = body2};
    return params;
}

collision_event_params_t *collision_event_params_init(body_t *body1,
                                                      body_t *body2,
                                                      collision_handler_t handler,
                                                      void *aux,
                                                      free_func_t freer,
                                                      bool was_colliding)
{
    ...
    *params = (collision_event_params_t){
        .body1 = body1,
        .body2 = body2,
        .handler = handler,
        .aux = aux,
...
void create_newtonian_gravity(scene_t *scene, double G, body_t *body1, body_t *body2)
{
    ...
    scene_add_bodies_force_creator(scene, (force_creator_t)gravity_forcer, params, bodies, free);
}
...
void create_spring(scene_t *scene, double k, body_t *body1, body_t *body2)
{
    ...
    list_t *bodies = get_bodies_list(body1, body2);
    scene_add_bodies_force_creator(scene, (force_creator_t)spring_forcer, params, bodies, free);
}
...
void create_drag(scene_t *scene, double gamma, body_t *body)
{
    ...
    scene_add_bodies_force_creator(scene, (force_creator_t)drag_forcer, params, bodies, free);
}

void destructive_forcer(body_t *body1, body_t *body2, vector_t axis, void *aux)
{
    body_remove(body1);
    body_remove(body2);
}
...
{
    create_collision(scene, body1, body2, (collision_handler_t)destructive_forcer, NULL, NULL);
}
...
void create_collision(
    ...
    free_func_t freer)
{
    collision_event_params_t *params = collision_event_params_init(body1, body2, handler, aux, freer, false);
    list_t *bodies = get_bodies_list(body1, body2);
    scene_add_bodies_force_creator(scene,
                                   (force_creator_t)collision_event_forcer,
                                   params,
                                   bodies,
...
vector_t impulse_to_body_1(body_t *body1, body_t *body2, vector_t axis, double elasticity)
{
...
void physics_collision_forcer(body_t *body1, body_t *body2, vector_t axis, collision_event_aux_t *aux)
{
    ...
    body_t *body2)
{
    ...
    create_collision(scene, body1, body2, (collision_handler_t)physics_collision_forcer, aux, free);
}
