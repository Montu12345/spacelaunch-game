 ...
 */
typedef void (*key_handler_t)(char key, key_event_type_t type, double held_time, void *event_args);
 ...
 *
 * @param args variable to pass to the event handler
...
/**
 * Sets the event arguments for the key handler.
 * 
 * @param args arbitrary type to pass into the key handler.
 */
 ...
 * @param score score of the game
 */
void sdl_create_timer(vector_t position, vector_t dimentions, double score);
