...
/**
 * Performs a shallow list copy to an already allocated list.
 * 
 * @param dest an allocated list to put the contents of src into
 * @param src an allocated list to put the contents of src into
 * @return none
 */
