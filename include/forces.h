 ...
 */
typedef void (*collision_handler_t)(body_t *body1, body_t *body2, vector_t axis, void *aux);
...
/**
 * For a collision, calculates the impulse necessary to body 1 for 
 * modelling an accurate collision.
 * 
 * @param body1 the first body in the collision
 * @param body2 the second body in the collision
 * @param axis vector pointing from the first body to the second body
 * @param elasticity coefficient of restitution of the collision
 */
vector_t impulse_to_body_1(
    body_t *body1,
    body_t *body2,
    vector_t axis,
    double elasticity);
